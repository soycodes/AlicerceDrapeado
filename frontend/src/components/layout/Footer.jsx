            ...
            <address className="not-italic space-y-4">
              <div className="flex items-start gap-3">
                ...
                <span className="font-body text-sm text-white/60 leading-relaxed">
                  Rua do Alto Alentejo, nº 183, 1ºDto<br />2870-301 Montijo, Setúbal
                </span>
              </div>
              <div className="flex items-center gap-3">
                <Phone size={15} className="text-gold-500 flex-shrink-0" />
                <a href="tel:+351926502295" className="font-body text-sm text-white/60 hover:text-gold-400 transition-colors duration-200">
                  +351 926 502 295
                </a>
              </div>
              <div className="flex items-center gap-3">
